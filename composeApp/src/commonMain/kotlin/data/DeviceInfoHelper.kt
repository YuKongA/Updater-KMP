...
object DeviceInfoHelper {
    ...
    private val embeddedDeviceList = listOf(
        ...
        Device("Redmi A3 / POCO C61", "blue", "GR"),
        ...
        Device("Redmi 14C / POCO C75", "lake", "GT"),
        Device("Redmi 14R 5G / POCO M7 5G", "flame", "GU"),
        ...
        Device("REDMI K80 Pro / POCO F7 Ultra", "miro", "OM"),
        Device("REDMI K80 Ultra", "dali", "ON"),
        Device("Xiaomi 14 Ultra", "aurora", "NA"),
        Device("Xiaomi Pad 6S Pro", "sheng", "NX"),
        Device("Redmi Pad Pro WiFi / POCO Pad", "dizi", "NS"),
        Device("Redmi Pad Pro 5G / POCO Pad 5G", "ruan", "FS"),
        Device("REDMI Pad 2 4G", "koto", "OW"),
        Device("REDMI Pad 2", "taiko", "OV"),
        Device("REDMI K Pad / Xiaomi Pad Mini", "turner", "AO"),
